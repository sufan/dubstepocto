...
let previewSchedule = TVScheduleModel(id: 555, name: "Avatar: The Last Airbender", season: 5, number: 4, airdate: "2020-08-20", airtime: "14:30", airstamp: "2020-08-20T18:30:00+00:00", runtime: 30, show: previewShow)
    
let previewShow = TVShowModel(id: 555, name: "Avatar: The Last Airbender", type: "Animation", language: "English", genres: ["Action","Adventure","Fantasy"], status: "Ended", runtime: 30, premiered: "2005-02-21", officialSite: "https://www.nick.com/shows/avatar", schedule: previewShowSchedule, rating: previewRating, weight: 82, network: previewNetwork, externals: previewShowExternals, image: previewShowImage, summary: "<p>Water. Earth. Fire. Air. Only the Avatar was the master of all four elements. Only he could stop the ruthless Fire Nation from conquering the world. But when the world needed him most, he disappeared. Until now... On the South Pole, a lone Water Tribe village struggles to survive. It's here that a young Waterbender named Katara and her warrior brother Sokka rescue a strange boy named Aang from a cavernous iceberg. Not only is Aang an Airbender--a race of people no one has seen in a century--but they soon discover that Aang is also the long lost Avatar. Now it's up to Katara and Sokka to make sure Aang faces his destiny to save the tribe--and himself. Did we mention he's only 12?</p>", updated: 1597812804)
    
let previewShowSchedule = TVShowScheduleModel(time: "11:00", days: ["Saturday"])

let previewRating = TVShowRatingModel(average: 8.9)

let previewNetwork = TVNetworkModel(id: 27, name: "Nickelodeon", country: previewCountry)

let previewCountry = TVCountryModel(name: "United States", code: "US", timezone: "America/New_York")

let previewShowExternals = TVShowExternalsModel(tvrage: 2680, thetvdb: 74852, imdb: "tt0417299")

let previewShowImage = TVImageModel(medium: "http://static.tvmaze.com/uploads/images/medium_portrait/79/199224.jpg", original: "http://static.tvmaze.com/uploads/images/original_untouched/79/199224.jpg")
